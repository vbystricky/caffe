...
#include "caffe/layers/fcn_crop_layer.hpp"

namespace caffe {

    template <typename Dtype>
    void FCNCropLayer<Dtype>::LayerSetUp(const vector<Blob<Dtype>*>& bottom,
    ...
    template <typename Dtype>
    void FCNCropLayer<Dtype>::Reshape(const vector<Blob<Dtype>*>& bottom,
        const vector<Blob<Dtype>*>& top) {
    ...
    template <typename Dtype>
    void FCNCropLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
        const vector<Blob<Dtype>*>& top) {
    ...
    template <typename Dtype>
    void FCNCropLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
#ifdef CPU_ONLY
    STUB_GPU(FCNCropLayer);
#endif

    INSTANTIATE_CLASS(FCNCropLayer);
    REGISTER_LAYER_CLASS(FCNCrop);
